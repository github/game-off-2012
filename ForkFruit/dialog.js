goog.provide('ForkFruit.dialogs');

ForkFruit.dialogs.blank = function() {
...
ForkFruit.dialogs.box1 = function() {
    var b = ForkFruit.dialogs.blank();
...
ForkFruit.dialogs.box2 = function() {
    var b = ForkFruit.dialogs.blank();
...
ForkFruit.dialogs.box3 = function(game) {
    var b = ForkFruit.dialogs.blank();
...
ForkFruit.dialogs.appear = function(b,callback) {
...
ForkFruit.dialogs.hide = function(b,callback) {
