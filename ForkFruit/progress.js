goog.provide('ForkFruit.Progress');
...
goog.inherits(ForkFruit.Progress, lime.RoundedRect);


ForkFruit.Progress.prototype.setProgress = function(value) {
    var hue_green = 0.27;
    var hue_red = 0.01;
...
ForkFruit.Progress.prototype.getProgress = function() {
