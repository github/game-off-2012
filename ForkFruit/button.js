 ...
 * @extends lime.Button
 */
ForkFruit.Button = function(txt) {
    lime.GlossyButton.call(this, txt);

    this.borderWidth = 4;
    this.setColor('#000');
};
goog.inherits(ForkFruit.Button, lime.GlossyButton);
 ...
 */
ForkFruit.Button.prototype.makeState_ = function() {
 ...
 */
ForkFruit.Button.prototype.setColor = function(clr) {
