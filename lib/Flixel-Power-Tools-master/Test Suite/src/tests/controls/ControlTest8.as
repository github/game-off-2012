package tests.controls 
{
	...
	public class ControlTest8 extends FlxState
	{
		//	Common variables
		public static var title:String = "Controls 8";
		public static var description:String = "Thrust with Gravity";
		...
		override public function create():void
		{
			...
			add(FlxCollision.createCameraWall(FlxG.camera, FlxCollision.CAMERA_WALL_INSIDE, 32, true));
